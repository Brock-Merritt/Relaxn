...
const Sad = () => {
    return(
        ...
        <div className="bottom-row">
            <div className="card">
                <iframe src="https://giphy.com/embed/xT77XOVcx7KPcNVihi" width="400" height="400" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><a href="https://giphy.com/gifs/creativemornings-you-are-awesome-kitty-lo-xT77XOVcx7KPcNVihi"></a>
            </div>
            <div className="card">
